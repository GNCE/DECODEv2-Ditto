...
@Configurable
@TeleOp(group="TeleOp", name="Manual RPM TeleOp")
public class ManualRPM extends MyCommandOpMode {

    @Override
    public void initialize() {
        r = new MyRobot_ManualRPM(hardwareMap, telemetry, gamepad1, gamepad2, List.of(SubsystemConfig.INTAKE, SubsystemConfig.TURRET, SubsystemConfig.SHOOTER, SubsystemConfig.DOOR, SubsystemConfig.FOLLOWER, SubsystemConfig.LIFT));
    }
