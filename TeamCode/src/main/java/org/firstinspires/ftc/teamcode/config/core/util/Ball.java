...
public class Ball {
    ...
    public double radiusPx;     // apparent radius reported by the pipeline (distance hint)

    public Ball(int id, Artifact color, Pose position, double nowSec, double radiusPx) {
        this.id = id;
        this.color = color;
