...
@Autonomous(group="Far Auto", name="OA auto")
public class OAuto extends MyCommandOpMode {
    AutoPaths autoPaths;
    ...
    public void atStart() {
        ...
        schedule(
                new SequentialCommandGroup(
                        ...
                        // DIAGONAL CYCLE 1
                        r.spinUpShooterFor(autoPaths.getPose(AutoPaths.PoseId.SHOOT_BACK_HP_PREP)),
                        new FollowPathCommand(r.f, autoPaths.getPath(AutoPaths.PathId.DIAGONAL_CYCLE_OA_1)),
                        r.goToLinear(autoPaths.getPose(AutoPaths.PoseId.SHOOT_BACK_HP_PREP)),
                        new WaitCommand(100),
                        r.shootAll(),
                        new InstantCommand(() -> r.door.setOpen(false)),
