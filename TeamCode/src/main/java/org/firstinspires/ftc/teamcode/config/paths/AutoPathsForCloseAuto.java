...
public final class AutoPathsForCloseAuto {
    // ====== POSES (BLUE ONLY) ======
    ...
    public enum PoseId {
        ...
        GATE_INTAKE_TRIPLE (new Pose(17.75+ X_OFFSET_FRONT, 59.75+Y_OFFSET_FRONT, Math.toRadians(155))), // 12.3 56.66 150.14
        GATE_INTAKE_SAFE_TRIPLE (new Pose(20.25+ X_OFFSET_FRONT, 55+Y_OFFSET_FRONT, Math.toRadians(151))),
        ...
        SINGLE_MID_SPIKE_START (new Pose(58, 80, Math.toRadians(206))),
    ...
    public enum PathId {
        ...
        GATE_INTAKE_SAFE_SAFE_TO_SHOOT_FINAl_FINAL
    }
    ...
    public AutoPathsForCloseAuto(Follower f, Alliance a) {
        this.f = f;
        this.a = a;
    ...
    private void buildPaths() {
        ...
        paths.put(PathId.GATE_INTAKE_SAFE_SAFE_TO_SHOOT_FINAl_FINAL,
                f.pathBuilder()
                        .addPath(new BezierLine(getPose(PoseId.GATE_INTAKE_SAFE_TRIPLE_SAFE), getPose(PoseId.FRONT_SHOOT_AFTER_GATE_FINAL_FINAL)))
                        .setHeadingInterpolation(HeadingInterpolator.piecewise(
                                HeadingInterpolator.PiecewiseNode.linear(0.0, 0.3, getPose(PoseId.GATE_INTAKE_SAFE_TRIPLE_SAFE).getHeading(), getPose(PoseId.FRONT_SHOOT_AFTER_GATE_FINAL).getHeading()),
                                HeadingInterpolator.PiecewiseNode.linear(0.3, 1, getPose(PoseId.FRONT_SHOOT_AFTER_GATE_FINAL).getHeading(), getPose(PoseId.FRONT_SHOOT_AFTER_GATE_FINAL).getHeading())
                        ))
