 ...
 */
public class MyPIDFController extends MyController {
     ...
     */
    public MyPIDFController(PIDFCoefficients coefficients) {
     ...
     */
    public MyPIDFController(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
     ...
     */
    public MyPIDFController setIntegrationControl(IntegrationControl integrationControl) {
